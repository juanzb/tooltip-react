    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p style={{ fontSize: "14px", color: "#555", marginBottom: "15px" }}>
            Usa <code>showArrow={`{false}`}</code> para remover la flecha del
            diseño.
          </p>
        ...
        <div>
          ...
          <p style={{ fontSize: "14px", color: "#555", marginBottom: "15px" }}>
            Usa <code>disabled={`{true}`}</code> para evitar que el tooltip se
            despliegue.
          </p>
        ...
        <div>
          ...
          <p style={{ fontSize: "14px", color: "#555", marginBottom: "15px" }}>
            Cambia colores con{" "}
            <code>style={`{{ backgroundColor: 'green', ... }}`}</code>.
          </p>
          <Tooltip
            label="Fondo verde"
            position="top"
        ...
        <div>
          ...
          <p style={{ fontSize: "14px", color: "#555", marginBottom: "15px" }}>
            Pasa <code>delayHide={`{1000}`}</code> para que tarde 1 segundo en
            desaparecer.
          </p>
          <Tooltip label="Me voy lento..." position="top" delayHide={1000}>
